  ...
  "slides": [
    ...
    },
    {
      ...
      "codeBlock": {
        ...
        "code": "// config.json — your entire video as data\nconst slide = {\n  heading: 'Hello World',\n  layout: 'split-media-right',\n  transition: 'cube-rotate',\n  chart: {\n    type: 'bar',\n    data: [\n      { label: 'Q1', value: 150 },\n      { label: 'Q2', value: 240 }\n    ]\n  }\n};\n\n// Then just run:\nnpm run render"
      }
    },
    {
      "id": "slide_13",
